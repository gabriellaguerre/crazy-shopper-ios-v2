...
function Items({ navigation, route, handleDoneClick }) {
  ...
  const newSearchItems = newItems.filter(item => item.item.toLowerCase().includes(searchName.toLowerCase()));
  ...
  return (
    ...
    <View style={styles.body}>
        ...
        <View>
          ...
          <View style={styles.searchBar}>
            <TextInput
              style={styles.input}
              placeholder='search'
              placeholderTextColor="#094a85"
              value={searchName}
              onChangeText={(value) => setSearchName(value)} /></View>
        </View>
      )}
      {hasItems && !hasVisibleItems ? (
        ...
        hasVisibleItems ? (
          <FlatList
            data={searchName.length > 0 ? newSearchItems : newItems}
            renderItem={({ item }) => (
                ...
                {Object.values(params).length > 0 ? (
                  ...
                  <View style={styles.listContainer}>
                    ...
                    <TouchableOpacity onPress={() => { toggleShowMenu(item.id) }}>
                      {showMenu[item.id] ? (
                        <Image style={styles.arrows} source={require('../../assets/arro-up-3100.png')} />
                      ) : (
                        <Image style={styles.arrows} source={require('../../assets/arrow-down-3101.png')} />
                      )}
                    </TouchableOpacity>
          ...
          <View style={styles.imageBody}>
            <Image style={styles.logo} source={require('../../assets/list.png')} />
      ...
      {Object.values(params).length > 0 && (
        <View style={styles.footer}>
          <TouchableOpacity style={styles.doneTouchable} onPress={handleDone}>
